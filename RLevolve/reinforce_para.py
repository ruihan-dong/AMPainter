...
if __name__ == "__main__":
    ...
    # load input seqs
    df_seq = pd.read_csv('./random200.txt', header=None)
    ...
    t0 = time()
    train_agent(save_path = './outputs/para_random200_step20_ite8_V1/',
                device = device, 
                model = model, 
                tokenizer = tokenizer, 
                ...
                batchs_seqs = initial_seq, n_steps = 20, iterations = 8, 
