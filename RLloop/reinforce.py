...
def train_agent(save_path, device, 
    ...
    for step in tqdm(range(n_steps)):
        ...
        for bn in range(batch_num):
            ...
            # Sample from Agent
            seqs, agent_likelihood = agent.sample(batch_seqs, iterations)
            if len(seqs) == 1:
                seqs = seqs[0]
            ...
            experience.add_experience(seqs, score, agent_likelihood)
...
if __name__ == "__main__":
    ...
    # Fine-tuned model
    finetune_dir = '../finetune/model_1by1/'
